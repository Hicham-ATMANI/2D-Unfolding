...
Bias_minusmunu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wminusmunu5/muEta/Bias_Wminusmunu5.root")

IsoSF_minusmunu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wminusmunu5/muEta/Syst_MuIsoSys.root")
RecoSF_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wminusmunu5/muEta/Syst_MuRecoSys.root")
TrigSF_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wminusmunu5/muEta/Syst_MuTrigSys.root")
Recoil_minusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wminusmunu5/muEta/Recoil_Syst.root")
...
NominalPlots.GetEpsilonFactors(Summarize_minusmunu5,                "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
#NominalPlots.MigrationMatrix(Summarize_minusmunu5,                  "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
#NominalPlots.ShowNominalDistribution(Summarize_minusmunu5,          "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
NominalPlots.CompareBias(Bias_minusmunu5, 1,  9,                   "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
NominalPlots.CompareStatError(Summarize_minusmunu5, 1,  9,         "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
NominalPlots.BiasProcedure( Summarize_minusmunu5, Bias_minusmunu5,  "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1 )
...
SystematicsStudy.CompareSystIso(  IsoSF_minusmunu5,  1, 9, "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
SystematicsStudy.CompareSystReco( RecoSF_minusmunu5, 1, 9, "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
SystematicsStudy.CompareSystTrig( TrigSF_minusmunu5, 1, 9, "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
SystematicsStudy.CompareSystRecoil(  Summarize_minusmunu5, Recoil_minusmunu5, 1, 9, "Wminusmunu5",   "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
SystematicsStudy.CompareSyst( Summarize_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, RecoSF_minusmunu5, TrigSF_minusmunu5, Recoil_minusmunu5, Recoil_minusmunu5, "Wminusmunu5", "W^{-}#rightarrow #mu^{-}#nu,   5TeV", 1)
...
#CrossSectionDeter.GetDiffernetialXsPlot(Summarize_minusmunu5, Bias_minusmunu5, TrigSF_minusmunu5, RecoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, IsoSF_minusmunu5, Recoil_minusmunu5, "5TeV", "W^{-}#rightarrow #mu^{-}#nu, 5TeV", "Wminusmunu5", 256.827, 1)
