...
Bias_plusmunu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusmunu5/muEta/Bias_Wplusmunu5.root")

IsoSF_plusmunu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusmunu5/muEta/Syst_MuIsoSys.root")
RecoSF_plusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusmunu5/muEta/Syst_MuRecoSys.root")
TrigSF_plusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusmunu5/muEta/Syst_MuTrigSys.root")
Recoil_plusmunu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusmunu5/muEta/Recoil_Syst.root")
...
NominalPlots.GetEpsilonFactors(Summarize_plusmunu5,                "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
#NominalPlots.MigrationMatrix(Summarize_plusmunu5,                  "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
#NominalPlots.ShowNominalDistribution(Summarize_plusmunu5,          "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
NominalPlots.CompareBias(Bias_plusmunu5, 1,  9,                   "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
NominalPlots.CompareStatError(Summarize_plusmunu5, 1,  9,         "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
NominalPlots.BiasProcedure( Summarize_plusmunu5, Bias_plusmunu5,   "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1 )
...
SystematicsStudy.CompareSystIso(  IsoSF_plusmunu5,  1, 9, "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
SystematicsStudy.CompareSystReco( RecoSF_plusmunu5, 1, 9, "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
SystematicsStudy.CompareSystTrig( TrigSF_plusmunu5, 1, 9, "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
SystematicsStudy.CompareSystRecoil(  Summarize_plusmunu5, Recoil_plusmunu5, 1, 9, "Wplusmunu5",   "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
SystematicsStudy.CompareSyst( Summarize_plusmunu5, IsoSF_plusmunu5, IsoSF_plusmunu5, RecoSF_plusmunu5, TrigSF_plusmunu5, Recoil_plusmunu5, Recoil_plusmunu5, "Wplusmunu5", "W^{+}#rightarrow #mu^{+}#nu,   5TeV", 1)
...
#CrossSectionDeter.GetDiffernetialXsPlot(Summarize_plusmunu5, Bias_plusmunu5, TrigSF_plusmunu5, RecoSF_plusmunu5, IsoSF_plusmunu5, IsoSF_plusmunu5, IsoSF_plusmunu5, Recoil_plusmunu5, "5TeV", "W^{+}#rightarrow #mu^{+}#nu, 5TeV", "Wplusmunu5", 256.827, 1)
