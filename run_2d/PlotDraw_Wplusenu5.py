...
Bias_plusenu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Bias_Wplusenu5.root")

IdSF_plusenu5       = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Syst_ElIDSys.root")
IsoSF_plusenu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Syst_ElIsoSys.root")
RecoSF_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Syst_ElRecoSys.root")
TrigSF_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Syst_ElTrigSys.root")
Calib_plusenu5      = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Calib_Syst.root")
Recoil_plusenu5     = ROOT.TFile.Open("/afs/cern.ch/work/h/hatmani/HistMaker_v1/Plotting/RooUnfold_2d/output_Wplusenu5/elEta/Recoil_Syst.root")
...
NominalPlots.GetEpsilonFactors(Summarize_plusenu5,                "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
#NominalPlots.MigrationMatrix(Summarize_plusenu5,                  "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
#NominalPlots.ShowNominalDistribution(Summarize_plusenu5,          "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
NominalPlots.CompareBias(Bias_plusenu5, 1,  9,                   "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
NominalPlots.CompareStatError(Summarize_plusenu5, 1,  9,         "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
NominalPlots.BiasProcedure( Summarize_plusenu5, Bias_plusenu5,    "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
...
SystematicsStudy.CompareSystId(   IdSF_plusenu5,   1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV")
SystematicsStudy.CompareSystIso(  IsoSF_plusenu5,  1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
SystematicsStudy.CompareSystReco( RecoSF_plusenu5, 1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
SystematicsStudy.CompareSystTrig( TrigSF_plusenu5, 1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)

SystematicsStudy.CompareSystRecoil(  Summarize_plusenu5, Recoil_plusenu5, 1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
SystematicsStudy.CompareSystCalib(  Summarize_plusenu5,  Calib_plusenu5,  1, 9, "Wplusenu5",   "W^{+}#rightarrow e^{+}#nu,   5TeV")
SystematicsStudy.CompareSyst( Summarize_plusenu5, IdSF_plusenu5, IsoSF_plusenu5, RecoSF_plusenu5, TrigSF_plusenu5, Recoil_plusenu5, Calib_plusenu5, "Wplusenu5", "W^{+}#rightarrow e^{+}#nu,   5TeV", 0)
...
#CrossSectionDeter.GetDiffernetialXsPlot(Summarize_plusenu5, Bias_plusenu5, TrigSF_plusenu5, RecoSF_plusenu5, IsoSF_plusenu5, IdSF_plusenu5, Calib_plusenu5, Recoil_plusenu5, "5TeV", "W^{+}#rightarrow e^{+}#nu, 5TeV", "Wplusenu5", 256.827, 0)
